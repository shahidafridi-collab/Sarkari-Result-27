        ...
        <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-200/80 p-6 md:p-8 mb-8">
            <div className="flex flex-col sm:flex-row justify-between items-start gap-6">
              ...
              <a href={job.importantLinks.applyOnline || '#'} target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto flex-shrink-0 bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-700 transition-all duration-200 flex items-center justify-center shadow-sm">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              {(job.eligibility || job.ageLimit) && (
                <div className="bg-white rounded-xl shadow-lg border border-gray-200/80 p-6 md:p-8">
                  <h2 className="text-2xl font-bold text-gray-800 mb-4 flex items-center"><UserCheck className="h-6 w-6 mr-3 text-blue-600" />Eligibility Criteria</h2>
              ...
              {job.additionalInfo?.applicationSteps?.length > 0 && (
                <div className="bg-white rounded-xl shadow-lg border border-gray-200/80 p-6">
                  <h2 className="text-2xl font-bold text-gray-800 mb-4 flex items-center"><FilePenLine className="h-6 w-6 mr-3 text-blue-600" />How to Apply</h2>
