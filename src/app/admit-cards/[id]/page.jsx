...
async function getJobsData(id) {
  const res = await fetch('https://gist.githubusercontent.com/shahidafridi-collab/d6610e1b9fb8e2617c2999d1edc0851c/raw/gistfile1.txt', { next: { revalidate: 3600 }, });
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: "Admit Cards", url: `https://www.sarkariresult27.com/admit-cards` },
          { name: `${job.title}`, url: `https://www.sarkariresult27.com/admit-cards/${id}` },
        ]}
      />
      <HowToSchema
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              {job.additionalInfo?.applicationSteps?.length > 0 && (
                <div className="bg-white rounded-xl shadow-lg border border-gray-200/80 p-6">
                  <h2 className="text-2xl font-bold text-gray-800 mb-4 flex items-center"><FilePenLine className="h-6 w-6 mr-3 text-blue-600" />How to Download Admit Card</h2>
